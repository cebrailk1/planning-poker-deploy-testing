...
<template>
  ...
  >
    ...
    >
      <h1 class="text-3xl mb-8 text-center tracking-wide">
      ...
      <button
        @click="createRoom"
        class="rounded-lg px-4 py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 text-gray-900 border-gray-300 shadow-sm hover:from-yellow-500 hover:to-yellow-700 transition duration-200"
      >
        Create Room
      </button>
